...
describe("# applyRemoveRequirement", () => {
  ...
  it("should not throw", async () => {
    await clearance.removeRequirement(newRequirement._id.toString());
    await clearance.applyRemoveRequirement(newRequirement._id.toString());
  });
